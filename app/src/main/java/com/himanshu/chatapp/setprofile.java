...
public class setprofile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mprogressbarofsetprofile = findViewById(R.id.progressbarofosaveprofile);
    ...
    private void sendImagetoStorage() {
        ...
        bitmap.compress(Bitmap.CompressFormat.JPEG, 25, byteArrayOutputStream);            // reduced size to 25%
        byte[] data = byteArrayOutputStream.toByteArray();                                     // compressed image is stored in data
    ...
    private void sendDataToCloudFirestore() {
        ...
        documentReference.set(userdata).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                Toast.makeText(setprofile.this, "Data on firestore sent success", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    @Override
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {                   // for selecting image from gallery
